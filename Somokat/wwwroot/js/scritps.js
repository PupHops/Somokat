...
window.onload = function () {
    ...
    if (balance !== null && balance !== 'undefined') {
        ...
        document.getElementById('bonusDisplay').innerText = balance + "₽";
        document.getElementById('bonusDisplay2').innerText = balance + "₽";
    } else {
        // Если значение баланса не найдено, выводим сообщение об ошибке
        document.getElementById('bonusDisplay').innerText = 'Balance not found';
    }
};
